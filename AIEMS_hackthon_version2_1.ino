...
void loop() 
{
  ...
  if(CO2>1000)
  {
   unsigned long int d1=1000;
    beep(d1);
  }
  if(CO>20)
  {
 unsigned long int d2=3000;
    beep(d2);
  }
}
...
void handle_OnConnect() 
{
   ...
   server.send(200, "text/html", SendHTML(Co2,CO,temperature,humidity,body_Temp));
  
}
String SendHTML( float Co2, float CO, float temp, float humi,float body_Temp)
{
